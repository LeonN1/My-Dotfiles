...
(gtk_accel_path "<Actions>/ThunarActions/uca-action-1679199557976277-1" "<Shift><Super>Return")
...
(gtk_accel_path "<Actions>/ThunarActions/uca-action-1682452206636879-1" "<Primary><Shift>c")
